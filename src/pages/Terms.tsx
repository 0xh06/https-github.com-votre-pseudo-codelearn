...
export default function Terms() {
  return (
    <div className="container mx-auto px-4 py-20 max-w-3xl">
      <Seo title="CGU" description="Conditions générales d'utilisation d'CodeLearn." />
      ...
      <div className="space-y-8">
        {[
      { title: '1. Acceptation des conditions', content: "En accédant à CodeLearn, vous acceptez d'être lié par ces CGU. Si vous n'acceptez pas ces conditions, veuillez ne pas utiliser la plateforme." },
      { title: '2. Description du service', content: "CodeLearn est une plateforme d'apprentissage en ligne proposant des cours d'algorithmique, des exercices pratiques et un assistant IA. Certaines fonctionnalités sont réservées aux abonnés payants." },
          ...
          { title: '4. Propriété intellectuelle', content: "Tout le contenu d'CodeLearn (cours, algorithmes, exercices, code) est protégé par le droit d'auteur. Vous ne pouvez pas reproduire, distribuer ou créer des œuvres dérivées sans autorisation." },
          ...
          { title: '6. Limitation de responsabilité', content: "CodeLearn est fourni 'tel quel'. Nous ne garantissons pas que le service sera toujours disponible, sans erreur ou adapté à vos besoins spécifiques. Notre responsabilité est limitée au montant de votre abonnement." },
        ].map((s, i) => (
